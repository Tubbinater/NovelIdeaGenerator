...
#template:
<a> @mood@ @genre@ story about @theme@ and @theme@, @wildcard@
<a> @mood@ @genre@ story @wildcard@ where you play as @character@ @goal@
<a> @mood@ @genre@ story about @theme@, where you play as @character:nopost@ @setting@
<a> @mood@ @genre@ story that takes place @setting@, where you play as @character@ @goal@
<a> @mood@ story about @theme@ [set, that takes place] @setting@, where you play as @character@ @goal@
<a> @mood@ [mix between, mashup of, blend of] the @genre:nomods@ and @genre:nomods@ story genres, where you play as @character@ @goal@
<a> @mood@ [mix between, mashup of, blend of] the @genre:nomods@ and @genre:nomods@ story genres, which tells a story of @theme@ and @theme@
<a> @mood@ @genre@ story @wildcard:always@
<a> @mood@ [mix between, mashup of, blend of] the @genre:nomods@ and @genre:nomods@ story genres @wildcard:always@
#end
